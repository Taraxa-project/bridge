...
contract TaraBridge is BridgeBase {
    constructor(address tara_addresss_on_eth, IBridgeLightClient light_client) BridgeBase(light_client) {
        connectors[Constants.TARA_PLACEHOLDER] = new TaraConnector(tara_addresss_on_eth);
