...
library G1Operations {
    ...
    function getG1Generator() internal pure returns (Fp2Operations.Fp2Point memory generator) {
    ...
    function isG1(Fp2Operations.Fp2Point memory point) internal pure returns (bool result) {
        return isG1Point(point.a, point.b);
    }

    function checkRange(Fp2Operations.Fp2Point memory point) internal pure returns (bool result) {
