...
library G2Operations {
    ...
    function doubleG2(Fp2Operations.G2Point memory value)
        internal
        view
        returns (Fp2Operations.G2Point memory result)
    {
        if (isG2Zero(value)) {
            return value;
        } else {
    ...
    function addG2(
        Fp2Operations.G2Point memory value1,
        Fp2Operations.G2Point memory value2
    )
        internal
        view
        returns (Fp2Operations.G2Point memory sum)
    {
        if (isG2Zero(value1)) {
            return value2;
        }
    ...
    function getTWISTB() internal pure returns (Fp2Operations.Fp2Point memory point) {
    ...
    function getG2Generator() internal pure returns (Fp2Operations.G2Point memory point) {
        // Current solidity version does not support Constants of non-value type
        // so we implemented this function
        return Fp2Operations.G2Point({
    ...
    function getG2Zero() internal pure returns (Fp2Operations.G2Point memory point) {
        // Current solidity version does not support Constants of non-value type
        // so we implemented this function
        return Fp2Operations.G2Point({
            x: Fp2Operations.Fp2Point({
    ...
    function isG2Point(Fp2Operations.Fp2Point memory x, Fp2Operations.Fp2Point memory y) internal pure returns (bool result) {
    ...
    function isG2(Fp2Operations.G2Point memory value) internal pure returns (bool result) {
    ...
    function isG2Zero(Fp2Operations.G2Point memory value) internal pure returns (bool result) {
