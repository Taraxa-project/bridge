...
contract RegisterDogeOnTara is Script {
    ...
    function run() public {
        ...
        address dogeMintingConnectorProxy = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ERC20MintingConnector.initialize, (address(taraBridge), TestERC20(dogeAddressOnTara), dogeAddressOnEth)
            )
        );
        ...
        taraBridge.registerContract(IBridgeConnector(dogeMintingConnectorProxy));
